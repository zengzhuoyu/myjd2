...
class CartController extends CommonController
{
    ...
    public function actionIndex()
    {
        ...
        $cart = Cart::find()->where('userid = :uid', [':uid' => $userid])->asArray()->all();//之后对该数组需要进行处理，所以用asArray
    ...
    {
        $cartid = (int) Yii::$app->request->get("cartid");
        $productnum = (int) Yii::$app->request->get("productnum");
        if(Cart::updateAll(['productnum' => $productnum], 'cartid = :cid', [':cid' => $cartid])){
