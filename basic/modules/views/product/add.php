                    ...
                    <div class="row-fluid form-wrapper">
                        ...
                        <div class="span9 with-sidebar">
                            <div class="container">
                                    ...
                                    echo $form->field($model, 'descr')->textarea(['id' => "wysi", 'class' => "span9 wysihtml5", 'style' => 'margin-left:120px']);//编辑器
                                    ...
                                    echo $form->field($model, 'cover')->fileInput(['class' => 'span9']);//图片上传
                                    ...
                                    <?php
                                        ...
                                        echo $form->field($model, 'pics[]')->fileInput(['class' => 'span9', 'multiple' => true,]);//多图上传 pics[] multiple属性规定输入字段可选择多个值
                                    ?>
                                    <?php
